...
test:
	...
	-@docker-compose -f docker-compose.test.yml run --rm app dockerize -wait tcp://db-test:3306 -timeout 60s dockerize -wait tcp://minio:9000 -timeout 60s gotest -p 1 -v github.com/gold-kou/ToeBeans/app/...
